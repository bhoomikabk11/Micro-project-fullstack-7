...
SECRET_KEY = 'django-insecure-5s8t@cmv()f155fydn5=oebu^0!24-=*8pv&_i+i_f5px5os7b'
...
AUTHENTICATION_BACKENDS = [
    'pets.backends.EmailBackend',  # Custom backend for email login
...
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'available_pets'
LOGOUT_REDIRECT_URL = 'available_pets'
...
# Uncomment and configure these for production (Gmail example):
...
# For console backend, this is what will appear as sender
DEFAULT_FROM_EMAIL = 'noreply@petadoption.com'
